...
export class SearchCityComponent implements OnInit {
  ...
  characters = [
    ...
    "Grodzisk Wielkopolski", "Gdynia", "Głogówek", "Głogów", "Golina", "Grybów", "Głubczyce", "Góra", "Grabów nad Prosną", "Gołańcz", "Glinojeck", "Gryfów Śląski", "Goniądz", "Gąbin", "Gorzów Śląski", "Garwolin", "Gostynin",
